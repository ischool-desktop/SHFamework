...
namespace Framework
{
    public class LogInfo
    {
        ...
        public LogInfo()
        {
            ...
            UserName = DSAServices.UserAccount;
            Timestamp = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss", System.Globalization.DateTimeFormatInfo.InvariantInfo);
        }

        public string UserName
        {
            get { return GetText("UserName"); }
            private set { SetText("UserName", value); }
        }
        ...
        internal XmlElement BaseElement
        {
    ...
    public static class LogInfoExtendFunctions
    { 
        public static void Save(this LogInfo logInfo)
        {
            Feature.Log.InsertLog(logInfo);
        }
        public static void SaveAll(this IEnumerable<LogInfo> logInfos)
        {
            Feature.Log.InsertLog(logInfos);
        }
    }
}
